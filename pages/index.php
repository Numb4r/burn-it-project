...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/landingimages.css">
...
<div class="ui large top fixed hidden menu">
    <div class="ui container">
        ...
        <div class="right menu">
            <div class="item">
                <a class="ui button" href="login.php">Entrar</a>
            </div>
            <div class="item">
                <a class="ui primary button" href="register.php">Registrar</a>
            </div>
        </div>
    </div>
</div>
...
<div class="pusher">
    <div class="ui inverted vertical masthead center aligned segment" id="iMasthead">
        ...
        <div class="ui container">
            <div class="ui large secondary inverted pointing menu" style="border-color: transparent;">
                ...
                <div class="right item">
                    <a class="ui inverted button" href="login.php">Entrar</a>
                    <a class="ui inverted button" href="register.php">Registrar</a>
                </div>
            </div>
        </div>
        ...
        <div class="ui text container">
            ...
            <a class="ui huge primary button" href="register.php">Registre-se <i class="right arrow icon"></i></a>
        </div>
